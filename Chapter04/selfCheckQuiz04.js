...
//      the display output will be: "one"
const q1 = '1';
switch (q1) {
    case '1':
        answer = "one";
...
//      the display output will be: "this is the one" // look out for syntax errors!
const q2 = 1;
switch (q2) {
    case '1':
        answer = "one";
...
//      the display output will be: "login"
let login = false;
let outputHolder = "";
...
//      the display output will be: "Welcome, that is a user: John"
...
//      the display output will be: "Wake up, it's morning"
let myTime = 9;
let output;
